...
async function main() {
  ...
  console.log('📅 This will add availability from today to 3 weeks ahead (10 AM - 12 PM and 2 PM - 5 PM daily)');
  console.log('');
  ...
  try {
    ...
    if (result.success) {
      ...
      console.log('   - Time slots: 10:00 AM to 12:00 PM and 2:00 PM to 5:00 PM (IST)');
      console.log('   - Total: 7 time slots per day');
      console.log('');
      process.exit(0);
    } else {
      console.error('');
